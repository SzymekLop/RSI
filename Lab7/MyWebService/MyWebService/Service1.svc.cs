...
namespace MyWebService
{
    ...
    public class RestService : IRestService
    {
        ...
        {
            new Person() { Id = 0, Name = "Aleksandra Wolska", Age = 23, Email = "wschodzaca@gmail.com"},
            new Person() { Id = 1, Name = "szymon Łopuszyński", Age = 22, Email = "szym3k@op.pl"},
            new Person() { Id = 2, Name = "Jan Kowalski", Age = 13, Email = "kowal@wp.pl"}
        };
